    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 relative overflow-hidden px-6">
      ...
      <div className="max-w-[480px] w-full relative z-10">
        <div className="text-center mb-10">
           ...
           <p className="text-xs font-black text-indigo-400 uppercase tracking-[0.3em] mb-3">Secure Login</p>
           <h1 className="text-4xl font-black text-white tracking-tight">Welcome Back</h1>
           <p className="text-slate-400 text-sm mt-2 font-medium">Sign in to your MarketPro account</p>
        </div>

        <div className="glass-card rounded-[3rem] p-10 lg:p-12 border-white/10 shadow-2xl backdrop-blur-3xl">
          {error && (
          ...
          <form onSubmit={submitHandler} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-end px-1">
                ...
                <Link to="#" className="text-[10px] font-bold text-indigo-400 hover:text-indigo-300 uppercase tracking-widest">Forgot password?</Link>
              </div>
              <div className="relative group">
                <input 
                  type="password" 
            ...
            <button 
              ...
              id="login-submit"
              disabled={loading}
              className="w-full btn-primary py-5 rounded-2xl flex items-center justify-center space-x-3 text-sm group mt-2"
            >
              {loading ? (
          ...
          <div className="mt-10 pt-8 border-t border-white/5 text-center">
            <p className="text-sm font-medium text-slate-400">
              ...
              <Link to="/register" className="font-black text-indigo-400 hover:text-indigo-300 transition-colors">
                Create one <UserPlus size={14} className="inline" />
              </Link>
            </p>
          </div>
        </div>
        
        <p className="text-center mt-8 text-[10px] font-medium text-slate-600">
